            ...
            <div>
              ...
              <div>
                <div className='flex'>
                  ...
                  }} className='p-2 w-full bg-gray-800 text-white rounded-lg border border-gray-700'></textarea>
                  ...
                  }} className='bg-purple-500 text-white px-4 py-2 rounded-lg shadow-lg ml-2 hover:bg-purple-600 transition duration-300'>Send</button>
                  </div>}
                </div>
              </div>
            </div>
